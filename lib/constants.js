...
export const APP_NAME = 'Jaskier'
export const SITE_DESCRIPTION =
  'My website/public API that serves as my home base online.'
export const REPO_URL = 'https://github.com/4lch4/Jaskier'
export const GIT_PROFILE_URL = 'https://github.com/4lch4'
