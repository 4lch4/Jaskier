  ...
  return (
    <section className="flex-col md:flex-row flex items-center md:justify-between mt-16 mb-16 md:mb-12">
      ...
      <p>
        ...
        Engineer at <ATag url="https://jbhunt.com" text="J. B. Hunt" /> and have
        been since January, 2019. Before that I did freelance development work
        under my company{' '}
        <ATag
          url="https://hasslefree.solutions"
          text="HassleFree Solutions, LLC"
        />
        .
        <br />
        <br />
        And why call the website{' '}
        <ATag url="https://witcher.fandom.com/wiki/Dandelion" text="Jaskier" />?
